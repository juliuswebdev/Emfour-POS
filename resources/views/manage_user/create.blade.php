      ...
      <div class="clearfix"></div>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            {!! Form::password('security_pin', ['class' => 'form-control', 'minlength' => '4', 'maxlenght' => '9', 'required', "onkeyup" => "if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')",  'placeholder' => __( 'business.security_pin' ) ]); !!}
          </div>
        </div>
