<div class="table-responsive">
    <table class="table table-bordered table-striped" id="sales_tips_report">
	    <thead>
	        <tr>
	    ...
	    <tfoot>
	        <tr class="bg-gray font-17 footer-total text-center">
                ...
                <td><span class="display_currency" id="footer_tip_amount" data-currency_symbol ="true"></span></td>
	        </tr>
	    </tfoot>
	</table>
</div>