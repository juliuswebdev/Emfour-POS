	...
	<div class="pos-form-actions">
		...
		<div class="col-md-12 wrapper-of-add-action">
			...
			@if($business_details->business_type_id == 1)
				<button type="button" data-toggle="modal" data-target="#restaurant-checkout" title="@lang('lang_v1.restaurant_checkout')" class="btn bg-primary mo-btn-hide">@lang('lang_v1.checkout')</button>
			@endif
			...
			@if($business_details->business_type_id == 1)
				...
				<button type="button" 
				class="@if($is_mobile) col-xs-6 @endif btn bg-red btn-default btn-flat no-print pos-express-finalize mo-btn-hide" 
			...
			<button type="button" 
				class="btn bg-black btn-default btn-flat sale-return @if($is_mobile) col-xs-6 @endif mo-btn-hide" 
				title="@lang('lang_v1.tooltip_sale_return')" >
				<i class="fas fa-undo fa-lg" aria-hidden="true"></i> @lang('lang_v1.sale_return')
			</button>

			@if(empty($edit))
				<button type="button" class="btn btn-danger btn-flat @if($is_mobile) col-xs-6 @else btn-xs @endif mo-btn-hide" id="pos-cancel"> <i class="fas fa-window-close"></i> @lang('sale.cancel')</button>
			@else
			...
			<button type="button" class="pull-right btn btn-primary btn-flat @if($is_mobile) col-xs-6 @endif mo-btn-hide" data-toggle="modal" data-target="#recent_transactions_modal" id="recent-transactions"> <i class="fas fa-clock"></i> @lang('lang_v1.recent_transactions')</button>
			@endif
