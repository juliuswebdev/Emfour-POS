			...
			<div class="modal-body">
				...
				<div class="box-body">
					<form action="{{ action('\App\Http\Controllers\SellPosController@saleReturnPinVerify') }}" class="form" method="post" id="frmSalePinVerify">
						...
						<div class="row">
							<div class="col-md-10">
								<input type="text" placeholder="@lang('lang_v1.enter_sale_return_9_digit_pin')" required="required" maxlength="9" minlength="4" name="sale_return_pin" class="form-control">
							</div>
							<div class="col-md-2">
